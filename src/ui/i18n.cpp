...
const QHash<QString, QString> &chineseTable()
{
    static const QHash<QString, QString> table = {
        ...
        {QStringLiteral("Credentials for the Tencent, Baidu, Youdao, Gemini, and Anthropic translation plugins. "
                        "Leave a service empty to keep reading its credentials from environment variables."),
         QStringLiteral("腾讯、百度、有道、Gemini 与 Anthropic 翻译插件的凭据。留空则继续从环境变量读取该服务的凭据。")},
        ...
        {QStringLiteral("Gemini API Key"), QStringLiteral("Gemini API 密钥")},
        {QStringLiteral("Gemini Model"), QStringLiteral("Gemini 模型")},
        {QStringLiteral("Gemini Endpoint"), QStringLiteral("Gemini 接口地址")},
        {QStringLiteral("Anthropic API Key"), QStringLiteral("Anthropic API 密钥")},
        {QStringLiteral("Anthropic Model"), QStringLiteral("Anthropic 模型")},
        {QStringLiteral("Anthropic Endpoint"), QStringLiteral("Anthropic 接口地址")},
